...
def buscar_dados_acao_alpha_vantage(ticker_b3, api_key, num_registros=10):
    # Adicionando num registros
    ticker = ticker_b3 + ".SA"
    
    # O outputsize=compact ainda busca 100 pontos, o que é bom para depois selecionarmos os últimos N
...
for ativo in top_10_acoes:
    try:
        ...
        # A função buscar_dados_acao_alpha_vantage busca 20 registros por padrão
...
if not df_total.empty:
    ...
    print("⚠️ Nenhum dado foi coletado para salvar no arquivo CSV.")
